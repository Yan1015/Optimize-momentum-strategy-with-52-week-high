...
df = pd.read_excel("C:\\Users\\zy108\\Desktop\\Statistical arbitrage\\project\\SA2.xlsx")
...
print(clean_df)
clean_df.to_csv("C:\\Users\\zy108\\Desktop\\Statistical arbitrage\\project\\daily_clean.csv", index=False)
